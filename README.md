...
Here is a link to a presentation summary of our findings: [Presentation](https://docs.google.com/presentation/d/1rgV0FIzK1ZAWEi6xt35em-JNRcYkSIC4ncL3lQRaBHY/edit?usp=sharing)

## Interactive App
![landing page app](https://github.com/yecatstevir/teambrainiac/blob/main/source/streamlit/landing_page.png?raw=True) 

Check out the interactive brain maps, graphs and descriptions of what we looked at in this study on our [Landing Page](https://share.streamlit.io/yecatstevir/teambrainiac/main/source/streamlit/landing_page.py)
