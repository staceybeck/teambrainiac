...
def plot_decisions(ds, labels, time, title, mask_type, run, file):
    """
    ...
    ax.set_title(f"{run}: Support Vector Decision Scores over {time} time points for test subjects 4 and 5")
